...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            ...
            {
                // If the location of 'value' is at the end of the list,
                // then we can call remove_tail
                if (curr == _tail)
                {
                    RemoveTail();
                }
                // For any other location of 'value', need to reconnect
                // the links to remove (set curr as null)
                else
                {
    ...
    public void Replace(int oldValue, int newValue)
    {
        ...
        while (curr is not null)
        {
            // If the value of 'curr' matches 'oldValue' we replace it
            // with 'newValue'
            ...
            // We keep going forward until 'curr' is null
            curr = curr.Next;
        }
    }
